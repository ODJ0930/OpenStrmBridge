...
```bash
curl -fsSL https://github.com/ODJ0930/OpenStrmBridge/releases/latest/download/openstrmbridge-manager.sh | sudo bash
```

或：

```bash
wget -qO- https://github.com/ODJ0930/OpenStrmBridge/releases/latest/download/openstrmbridge-manager.sh | sudo bash
```
